...
talk("Hello! I am HomeBot, your personal cooking helper. I will help you with all your cooking needs, plus helping you text people while you are cooking so you don't get your hands dirty.")
...
while not allgood:
   ...
   famlike=raw_input()
   talk("So you have %r %r, and %r." % (favmeal, favmealfreq, favmealfam.replace("my", "your"))
time.sleep(2)
...
timeweek=raw_input()
time.sleep(1)
talk("Ok, I'll help you make %s %s times this week.") % (favmeal, favmealweek)
